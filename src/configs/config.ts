...
export const MAX_FILE_SIZE_IMAGE = parseInt(
  process.env.MAX_FILE_SIZE_IMAGE || `${5 * 1024 * 1024}`,
  10,
);
export const MAX_FILE_SIZE_VIDEO = parseInt(
...
export const NODEMAILER_PORT = parseInt(
...
export const OTP_TTL = parseInt(process.env.OTP_TTL || '300', 10);
export const OTP_RESEND_TIME = parseInt(
